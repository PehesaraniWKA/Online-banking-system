(function(global) {
    ...
    function createMonthTable(data, option) {
        ...
        while (c <= 6) {
            ...
            if (data.today.date === count && data.today.monthIndex === data.monthIndex && option.highlighttoday === true) {
                td.setAttribute("class", "mycalendar-today-date");
            }
            if (option.date === count && option.month === data.monthIndex && option.highlighttargetdate === true) {
                td.setAttribute("class", "mycalendar-target-date");
            }
            tr.appendChild(td);
            count = count + 1;
            c = c + 1;
    ...
    function drawCalendarMonthTable(data, option) {
        ...
        container.setAttribute("class", "mycalendar-month-container");

        //header div
        div = document.createElement("div");
        div.setAttribute("class", "mycalendar-header");
        div.setAttribute("data-option", JSON.stringify(option));

        //prev button
        if (option.prevnextbutton === "show") {
            elem = document.createElement("span");
            elem.setAttribute("class", "mycalendar-prev-next-btn prev-btn");
        ...
        //month span
        elem = document.createElement("span");
        elem.setAttribute("class", "mycalendar-span-month-year");
        ...
        if (option.prevnextbutton === "show") {
            elem = document.createElement("span");
            elem.setAttribute("class", "mycalendar-prev-next-btn next-btn");
            elem.setAttribute("data-date", option.date);
            elem.setAttribute("data-month", option.month);
            elem.setAttribute("data-year", option.year);
        ...
        //body div
        div = document.createElement("div");
        div.setAttribute("class", "mycalendar-body");
    ...
    function drawCalendarDay(data, option) {
        ...
        //calendar container
        container = document.createElement("div");
        container.setAttribute("class", "mycalendar-day-container");
        ...
        //day span
        elem = document.createElement("span");
        elem.setAttribute("class", "mycalendar-span-day");
        if (option.dayformat === "dd") {
        ...
        //date span
        elem = document.createElement("span");
        elem.setAttribute("class", "mycalendar-span-date");
        ...
        //footer div
        div = document.createElement("div");
        div.setAttribute("class", "mycalendar-footer");
    ...
    function onClick() {
        ...
        document.body.onclick = function(e) {
            ...
            if ((targetDomObject) && (targetDomObject.classList) && (targetDomObject.classList.contains("mycalendar-prev-next-btn"))) {
            ...
            //month click
            //extra checks to make sure object exists and contains the class of interest
            if ((targetDomObject) && (targetDomObject.classList) && (targetDomObject.classList.contains("mycalendar-span-month-year"))) {
                option = JSON.parse(targetDomObject.parentElement.getAttribute("data-option"));
                dateObj = new Date();
    ...
    mycalendar.draw = function(option) {
        ...
        var
            self = this, //pointing at mycalendar object
